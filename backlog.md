...
- [ ] **`lab/research/claude-code-docs/` is stale.** `tools-reference.md` and `sub-agents.md` describe `TaskOutput`, removed in 2.1.277, and the folder holds no `memory.md`, the page that says how `AGENTS.md` loads. Found 2026-09-21.
