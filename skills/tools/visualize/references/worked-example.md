...
**The close:** key interactions as short prose steps ("Press play: the controller schedules the clips..."), then exactly 2 decision points ("Playback code fully outside React, OK?").
