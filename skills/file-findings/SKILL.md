...
6. Mark every ticket you swept — `flow file t047 t048 t049`, including the ones that taught nothing. Recording that a ticket was looked at is what drains the queue.
...
Creating a ticket is fair game when an inbox item turns out to be committed work — `flow new`. Work you merely *might* do stays in the inbox; the test is commitment, not size.
