...
Flow answers: **in the global rules and the agent's own judgment.** The Judgment section in `global/CLAUDE.md` says: attack your own proposal, walk a real case, find the missing step. The Communication section says: reason before agreeing, disagree out loud. The discipline is stated once at the top and expected to propagate everywhere.
...
| Always-on content | session-start hook injecting meta-skill | global/CLAUDE.md loaded by Claude Code |
...
| Behavioral mechanisms | Common Rationalizations tables, Verification checklists, Red Flags, pressure-case evals | Judgment section in global/CLAUDE.md |
