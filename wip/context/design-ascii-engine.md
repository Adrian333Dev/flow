...
the result beside `skills/visualize/refs/hooks-lifecycle.md`. If either comes close, the engine is a
...
- **Where the engine lives.** `skills/visualize/scripts/` alongside `canvas.js`, or `global/scripts/` as a
