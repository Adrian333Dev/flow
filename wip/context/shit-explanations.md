...
`wip/study-cases/bad-explanations/` holds the same class of failure from 2026-08-08 and 2026-08-09.
Merge the two folders whenever one of them gets read.
...
- **Calibrate tech** against `wip/context/user-profile.md`.
...
`global/refs/writing.md` §5 already carries the test — *"Act on it after one read. Re-reading to
